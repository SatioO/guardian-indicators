var __pineMod = (() => {
  ...
  function __gScriptRunV2(__gScriptInternalContextV1) {
    ...
    const surgeAt = input.float(2, "Surge at (\xD7 average)", { id: "surge-at", min: 0, step: 0.1 });
...
globalThis.compute = globalThis.__pine.makeComputeForVersion(2,"g-script-v2",__pineMod.__gScriptRunV2,{"mode":"native-event","declarationFingerprint":"pine-event-declarations/v1/ebf26189303de961","declarations":[{"slot":0,"kind":"plot","kindOrdinal":0,"source":{"file":"indicator.ts","line":16,"column":1},"valueType":"number","qualifiers":{"value":"series","title":"const","color":"series","lineWidth":"const","style":"const","histBase":"const","editable":"const","showLast":"const","display":"const","format":"const","precision":"const","offsetBars":"const","forceOverlay":"const"},"style":"columns","histBase":0},{"slot":1,"kind":"hline","kindOrdinal":0,"source":{"file":"indicator.ts","line":24,"column":1},"valueType":"number","qualifiers":{"value":"const","title":"const","color":"const","lineWidth":"const","lineStyle":"const"}},{"slot":2,"kind":"hline","kindOrdinal":1,"source":{"file":"indicator.ts","line":25,"column":1},"valueType":"number","qualifiers":{"value":"input","title":"const","color":"input","lineWidth":"const","lineStyle":"const"}},{"slot":3,"kind":"plot","kindOrdinal":1,"source":{"file":"indicator.ts","line":26,"column":1},"valueType":"number","qualifiers":{"value":"series","title":"const","color":"const","lineWidth":"const","style":"const","histBase":"const","editable":"const","showLast":"const","display":"const","format":"const","precision":"const","offsetBars":"const","forceOverlay":"const"},"style":"line","histBase":0}],"alertConditions":[{"id":"bullish-volume-surge","title":"Bullish volume surge","message":"Volume reached the surge multiple of its average on an up bar"},{"id":"bearish-volume-surge","title":"Bearish volume surge","message":"Volume reached the surge multiple of its average on a down bar"}]});
